...
import com.adjemin.dix.properties.Account as PAccount
import com.adjemin.dix.properties.Address as PAddress
import com.adjemin.dix.properties.Email as PEmail
import com.adjemin.dix.properties.Event as PEvent
import com.adjemin.dix.properties.Name as PName
import com.adjemin.dix.properties.Note as PNote
import com.adjemin.dix.properties.Organization as POrganization
import com.adjemin.dix.properties.Phone as PPhone
import com.adjemin.dix.properties.SocialMedia as PSocialMedia
import com.adjemin.dix.properties.Website as PWebsite
...
class FlutterContacts {
    companion object {
        fun get(
            ...
            var contacts = mutableListOf<DixContact>()
            if (cursor == null) {
                return listOf()
            }
            ...
            while (cursor.moveToNext()) {
                ...
                var contact: DixContact = contacts[index[id]!!]
        ...
        fun new(
            ...
            val contact = DixContact.fromMap(contactMap)
        ...
        fun updateAll( resolver: ContentResolver,
                       contactList:List<Map<String, Any?>>): List<String?>{

            val list = arrayListOf<String?>()

            contactList.forEach {

               val m =  update(resolver,it,false)
                list.add(m)
            }
