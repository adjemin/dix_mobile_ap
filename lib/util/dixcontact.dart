...
class DixContact {
  ...
  DixContact.create({bool createEmptyName = true})
  ...
  factory DixContact.fromJson(Map json) {
    DixContact contact = _$DixContactFromJson(json);
  ...
  Map<String, dynamic> toJson({bool includePhoto = false}) {
    Map<String, dynamic> json = _$DixContactToJson(this);
    // photo requires special handling since it's ignored by json serialization
